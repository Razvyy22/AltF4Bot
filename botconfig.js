module.exports = {
  Admins: ["257938005040300033", "UserID"], //Admins of the bot
  ExpressServer: true, //If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || "!", //Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/2set44VQBE", //Support Server Link
  ...
  IconURL:
    "https://raw.githubusercontent.com/Razvyy22/AltF4Bot/main/assets/logo.gif", //URL of all embed author icons | Dont edit unless you dont need that Music CD Spining
  ...
  Presence: {
    ...
    name: "ALT F4", // The message shown
    type: "STREAMING", // PLAYING, WATCHING, LISTENING, STREAMING
    url: "https://www.twitch.tv/razvy_22", // Stream URL
  },
